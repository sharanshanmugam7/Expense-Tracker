...
export function Button(props) 
{
    ...
    return(
        <button className={props.className}  style={buttonStyle}>{props.placeHolder}</button>
    )
}
/*
...
export function InputBox(props)
{
    ...
    return (
        <input className={props.className} type={props.type} style={inputBoxStyle} placeholder={props.placeHolder} autoComplete={props.autoComplete}></input>
        )
}
/*
